...
<div class="w3-containerx " id="contact">
	...
	<div class="w3-margin w3-padding " >
		<div class="w3-center"><img src="images/logo.jpg" class="w3-image"></div>

		<div class="w3-padding-64"></div>

		<a href="menu.php" class="w3-padding-large w3-block w3-button  w3-margin-bottom w3-round-xxlarge w3-green"><b>Let's Get Started</b></a>
    </div>
	</div>
</div>
